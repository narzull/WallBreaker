...
public class Level implements Observable {
	...
	public void initializeLevel() {
		 ...
		 */
		/*
		 * for(Integer i=0 ; i <= this.nbBricksXMax ; i++) for(Integer j=0 ; j
		 * <= this.nbBricksYMax ; j++) this.bricks.add(new
		 * Brick(i*60/100,j*30/100,60/100,30/100,"src/img/brick1.png"));
		 */
